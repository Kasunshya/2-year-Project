                    ...
                    <?php if (!empty($data['promotions'])): ?>
                        <?php foreach($data['promotions'] as $promotion): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <button class="btn btn-sm" onclick='openEditModal(<?php echo json_encode($promotion); ?>)'>
                                        <i class="fas fa-edit"></i> Edit
                                    </button>
                                    <button class="btn btn-sm btn-danger" onclick="confirmDelete(<?php echo $promotion->id; ?>)">
