                ...
                <table>
                    ...
                    <tbody id="employeeTable">
                        ...
                        <tr data-dob="<?php echo $employee->dob; ?>" data-join-date="<?php echo $employee->join_date; ?>">
                            ...
                            <td class="actions">
                                <button class="btn edit-btn" onclick="openEditModal(<?php echo $employee->employee_id; ?>)">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="btn delete-btn" onclick="deleteEmployee(<?php echo $employee->employee_id; ?>)">
