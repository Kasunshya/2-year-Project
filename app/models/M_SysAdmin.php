...
if (!class_exists('M_SysAdmin')) {
    class M_SysAdmin
    {
        ...
        {
            $this->db->query('INSERT INTO employee (full_name, address, contact_no, nic, dob, gender, email, join_date, cv_upload, branch, user_id, user_role) VALUES (:full_name, :address, :contact_no, :nic, :dob, :gender, :email, :join_date, :cv_upload, :branch, :user_id, :user_role)');
        ...
        {
            $this->db->query('UPDATE employee SET full_name = :full_name, address = :address, contact_no = :contact_no, nic = :nic, dob = :dob, gender = :gender, email = :email, join_date = :join_date, cv_upload = :cv_upload, branch = :branch, user_role = :user_role WHERE employee_id = :employee_id');
